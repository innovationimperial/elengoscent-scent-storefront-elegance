...
const Navbar = () => {
  ...
  return <nav className="bg-white shadow-sm py-4 sticky top-0 z-50">
      <div className="container mx-auto px-4 flex justify-between items-center">
        ...
        <Link to="/" className="flex items-center">
          <div className="font-playfair text-2xl font-bold">
            <span className="text-zinc-950">Elengo</span>
        ...
        <div className="hidden md:flex items-center space-x-4">
          ...
          <Link to="/cart" className="relative hover:text-elengo-lavender transition-colors">
            ...
            {getCartCount() > 0 && <span className="absolute -top-2 -right-2 bg-elengo-lavender text-white rounded-full w-5 h-5 flex items-center justify-center text-xs">
                {getCartCount()}
              </span>}
          </Link>
        </div>
      ...
      {/* Mobile Menu */}
      {isMenuOpen && <div className="md:hidden bg-white border-t mt-4 py-4 px-6 animate-fade-in">
